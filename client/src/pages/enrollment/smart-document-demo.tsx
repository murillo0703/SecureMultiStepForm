          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setCompanyData(prev => ({ ...prev, selectedCarrier: value }))}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setCompanyData(prev => ({ ...prev, employeeCount: parseInt(value) }))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2 pt-2">
                <Switch
                  ...
                  onCheckedChange={(checked) => setCompanyData(prev => ({ ...prev, hasPriorCoverage: checked }))}
                />
      ...
      <Card className="bg-blue-50 border-blue-200">
        ...
        <CardContent className="text-blue-700">
          <div className="space-y-2 text-sm">
            <p><strong>Scenario 1:</strong> Select "Anthem" as carrier → Notice Officer Eligibility Form appears</p>
            <p><strong>Scenario 2:</strong> Toggle "Prior Coverage" to Yes → Prior coverage documents are now required</p>
            <p><strong>Scenario 3:</strong> Set employees to 55 → Large group ACA documents are added</p>
            <p><strong>Scenario 4:</strong> Upload a "DE9C" document → CCSB offer letter requirement disappears</p>
          </div>
        </CardContent>
      </Card>
    </div>

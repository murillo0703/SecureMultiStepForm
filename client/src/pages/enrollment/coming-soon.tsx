            ...
            <CardContent className="space-y-6">
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                ...
                <p className="mt-1 text-sm text-blue-600">
                  We're working on making this feature available to you. In the next release, 
                  you'll be able to add and manage employee information directly through this interface.
                </p>
              </div>

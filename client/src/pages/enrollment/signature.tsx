  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center sm:text-left">Sign Your Application</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="bg-muted p-4 rounded-md max-h-[300px] overflow-y-auto text-sm">
              ...
              <p className="mb-4">
                By signing this application, I {user?.username || "Applicant"}, an authorized representative of {company.name}, 
              ...
              <ol className="list-decimal pl-5 space-y-2">
                ...
                <li>
                  I understand that any false statements or misrepresentations may result in the denial of this application.
                </li>
                <li>
                  I authorize Murillo Insurance Agency to submit this application and all supporting documents to the selected insurance carriers.
                </li>
                <li>
                  I understand that this application is subject to approval by the insurance carriers, and coverage is not guaranteed until approved.
                </li>
                <li>
                  I acknowledge that premium rates will be determined by the insurance carriers based on multiple factors including census data, location, and plan selections.
                </li>
                <li>
                  I agree to provide any additional information that may be required to process this application.
                </li>
              </ol>
              
              <h3 className="font-medium mt-6 mb-2">Privacy Statement</h3>
              <p>
                The information collected in this application will be used solely for the purpose of obtaining health insurance coverage. 
                We will not sell or distribute your information to unaffiliated third parties. 
            ...
            <div className="flex items-start space-x-2">
              ...
              <div className="grid gap-1.5 leading-none">
                ...
                <p className="text-xs text-muted-foreground">
                  By checking this box, you acknowledge that you have read and agree to the terms above.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        {submissionStatus === "success" && (
          <Alert className="bg-green-50 border-green-200">
            ...
            <AlertDescription className="text-green-600">
              Your application has been successfully signed and submitted. You will be redirected to the confirmation page.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Button 
            type="submit"
            disabled={signatureMutation.isPending || !signature || !agreement || submissionStatus === "success"}

...
const relationshipOptions = [
  ...
  { value: "benefits_admin", label: "Benefits Administrator", autoFill: "authorized", requiresSignAuth: false },
  ...
  useEffect(() => {
    if (watchedRelationship) {
      ...
      if (selectedOption) {
        ...
        form.setValue("isAuthorizedContact", 
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              This information helps us track who submitted the application and may pre-fill sections later if you're also a key contact.
            </p>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          ...
                          {!form.watch("isEmailVerified") && !sendVerificationMutation.isPending && "Verify"}
                        </Button>
                      </div>
                      <FormMessage />
                    </FormItem>
                ...
                {(watchedRelationship === "owner" || watchedRelationship === "hr_manager" || watchedRelationship === "benefits_admin") && (
                  <div className="space-y-4 p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="text-sm text-blue-700">
                      Based on your role, you may also be a key contact we need information for. Check the boxes below to pre-fill those sections with your information.
                    </p>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                            ...
                            <div className="space-y-1 leading-none">
                              <FormLabel>I am the authorized contact for benefits decisions</FormLabel>
                              <p className="text-xs text-gray-600">

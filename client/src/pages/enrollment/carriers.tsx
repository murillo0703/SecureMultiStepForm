      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>Choose the insurance carrier you want to apply for</CardDescription>
          </CardHeader>
          ...
          <CardContent>
              ...
              {CARRIERS.map(carrier => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {selectedCarrier === carrier.id && <Check className="h-5 w-5 text-primary" />}
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex justify-end">
              <Button onClick={handleContinue} disabled={isLoading || !selectedCarrier}>
                {isLoading ? (
                  <>

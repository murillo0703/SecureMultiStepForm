        ...
        <Card className="w-full max-w-md mx-4">
          <CardHeader>
            ...
            <CardDescription className="text-center">
              {featureName} is currently under development and will be available in a future
              version.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-gray-500 text-center">
                We're working hard to bring you this feature. In the meantime, you can continue with
